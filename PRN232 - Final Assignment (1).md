...
- Pricing service. • AI/ML inference service. 

- Inventory service. • User profile service. 

## **3. Deployment Requirements** 

The entire system must be deployable using one of the following approaches: 

- Docker Desktop with Docker Compose. • A public cloud platform (Azure, AWS, Google Cloud, Render, Railway, etc.). 
