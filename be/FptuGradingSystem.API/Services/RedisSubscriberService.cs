    ...
    public class RedisSubscriberService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("RedisSubscriberService: Redis is not connected. Real-time ZIP notifications via SignalR will be disabled.");
            ...
            {
                _logger.LogWarning(ex, "RedisSubscriberService: Could not connect to Redis. SignalR real-time updates will be disabled. The API will continue to work normally.");
                return Task.CompletedTask;
            }
        }
